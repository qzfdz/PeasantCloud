 ...
 *
 */
public class SegmentViewFriendCircle extends LinearLayout {  
    private TextView textView1;  
    private TextView textView2;  
    private onSegmentViewClickListener listener;  
    public SegmentViewFriendCircle(Context context, AttributeSet attrs) {  
        super(context, attrs);  
        init();  
    }  
      
    public SegmentViewFriendCircle(Context context) {  
        super(context);  
        init();  
    }  
